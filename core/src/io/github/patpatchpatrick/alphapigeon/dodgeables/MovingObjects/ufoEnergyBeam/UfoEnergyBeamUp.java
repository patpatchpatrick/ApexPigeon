...
public class UfoEnergyBeamUp extends Dodgeable {
    ...
    public UfoEnergyBeamUp(World gameWorld, AlphaPigeon game, OrthographicCamera camera, Dodgeables dodgeables) {
        ...
        loader.attachFixture(dodgeableBody, "EnergyBeamUp", energyBeamFixtureDef, WIDTH);
    }
