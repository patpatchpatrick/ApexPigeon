...
public class UfoEnergyBeamRight extends Dodgeable {
    ...
    public UfoEnergyBeamRight(World gameWorld, AlphaPigeon game, OrthographicCamera camera, Dodgeables dodgeables) {
        ...
        loader.attachFixture(dodgeableBody, "EnergyBeamRight", energyBeamFixtureDef, WIDTH);
